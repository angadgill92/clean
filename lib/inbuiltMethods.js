...
/* This file contains various methods and properties supported by the parent type. Also, the accepted and return types of those methods */
...
const inbuiltProps = {
  'array': {
    ...
    'map': setValues(true, false, false, [AST.NEEDS_INFERENCE], arrayType),
    'filter': setValues(true, false, false, [AST.NEEDS_INFERENCE], arrayType),
    'reduce': setValues(true, false, false, [AST.NEEDS_INFERENCE], AST.NEEDS_INFERENCE),
    'includes': setValues(true, false, false, [AST.NEEDS_INFERENCE], 'bool'),
  ...
  'regexp': {
    'exec': setValues(true, false, false, ['string'], 'array')
  },
  [AST.NEEDS_INFERENCE]: {
    'length': {spec: setValues(false, true, false, null, 'number'), parentType: AST.NEEDS_INFERENCE},
    ...
    'splice': {spec: setValues(true, false, true, null, null), parentType: AST.NEEDS_INFERENCE},
    'slice': {spec: setValues(true, false, false, ['number', 'number'], AST.NEEDS_INFERENCE), parentType: AST.NEEDS_INFERENCE},
    'map': {spec: setValues(true, false, false, [AST.NEEDS_INFERENCE], arrayType), parentType: arrayType},
    'filter': {spec: setValues(true, false, false, [AST.NEEDS_INFERENCE], arrayType), parentType: arrayType},
    'reduce': {spec: setValues(true, false, false, [AST.NEEDS_INFERENCE], AST.NEEDS_INFERENCE), parentType: arrayType},
    'includes': {spec: setValues(true, false, false, [AST.NEEDS_INFERENCE], 'bool'), parentType: AST.NEEDS_INFERENCE},
    'join': {spec: setValues(true, false, false, ['string'], 'string'), parentType: arrayType},
    'toString': {spec: setValues(true, false, false, null, 'string'), parentType: AST.NEEDS_INFERENCE},
...
const inbuiltObjects = {
  ...
  'console': {
    type: 'object',
    propTypes: {
      'log': [[AST.NEEDS_INFERENCE], 'IO']
    }
  }
}

/* Module export inbuiltProps */
module.exports = {inbuiltProps, inbuiltObjects}
